...
```
The interval that contains the maximum number of steps is `r maxStepsPerInterval$interval`
...
The mean of the total number of steps taken per day using the dataset with NA filled in is `r meanStepsPerDayFilledIn`.
The median of the total number of steps taken per day using the dataset with NA filled in is `r medianStepsPerDayFilledIn`.
